...
CEDEN.subset <- CEDEN[, c("Region", "Analyte", "Result", "MDL", "SampleDate", "TargetLatitude",
                          "TargetLongitude", "CollectionMethodName", "Unit")] #subset CEDEN columns that exist as synonyms within SURF
SURF.subset <- SURF[, c("Region", "Chemical_name", "Concentration__ppb_", "Method_detection_level__ppb_",
                        "Sample_date", "Latitude", "Longitude", "Sample_type")] #subset SURF columns that exist as synonyms within CEDEN
