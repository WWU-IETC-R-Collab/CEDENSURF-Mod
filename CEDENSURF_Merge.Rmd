...
Even allowing for WQ parameters to be duplicated due to multiple species assessed on the same day, there are still `r nrow(CEDENMod_Tox) - nrow(Check)` duplicates, which should not be included.
...
We're left with only `r nrow(Check)` unique, useful records in the tox dataset - or `r 100*nrow(Check)/nrow(CEDENMod_Tox)`
